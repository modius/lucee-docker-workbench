...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
		<data-source allow="511" blob="false" class="org.gjt.mm.mysql.Driver" clob="false" connectionTimeout="1" custom="useUnicode=true&amp;characterEncoding=UTF-8&amp;useLegacyDatetimeCode=true" database="gpml" dbdriver="MySQL" dsn="jdbc:mysql://{host}:{port}/{database}" host="192.168.104.190" metaCacheTimeout="60000" name="gpml" password="encrypted:cc05f884338208c3502b71fca2025ec4bcc0ba5e3eee5186b4ba4e3481fbc3f3" port="3306" storage="false" username="root" validate="false"/>
	</data-sources>
	...
	directory mapping:
		...
		<mapping physical="{lucee-web}/components/farcry" primary="physical" toplevel="true" trusted="false" virtual="/farcry"/>
		<mapping physical="{lucee-web}/components/farcry/core/webtop" primary="physical" toplevel="true" trusted="false" virtual="/webtop"/>
